...
call "%CC%" -Oz -T src\link1000.ld -o build\main.bin src\main.c src\audio.c src\disk.c src\mli.s
if errorlevel 1 goto fail
call "%CC%" -Oz -T src\link1000.ld -DVERA_BASE=0xC400 -o build\main4.bin src\main.c src\audio.c src\disk.c src\mli.s
if errorlevel 1 goto fail
