...
* 玩家戰機固定於螢幕中央（104, 120），世界背景與 8 朵大小雲層（小雲 16×16、中雲 32×16、大雲 64×16）依照戰機航向產生 3 階視差滑動。
...
* **時代圖標**：右側邊緣以 8×8 微型精靈標示目前所處的歷史時代。
...
* **22 步動態超空間曲速光束**：倒數 1 秒時響起空間升頻嘯叫，戰機水平置中加速，亮白光束由中央向兩側爆發擴展至 28 欄全寬。戰機在光柱中央高速頻閃後，光束極速凝聚塌縮為單點，戰機隨之躍遷消失！
