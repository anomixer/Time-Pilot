...
| **開局宣告體驗** | 靜態宣告畫面，開場曲 7.12 秒<br>(Demo 模式因長度限制尾音被提早截斷；正式遊玩會完整播完，但操作鎖死) | 靜態宣告畫面，播放 Ensoniq 波表合成音樂 | **動態巡航宣告畫面**：開場曲播放 8.0 秒期間，**戰機與雲朵即時飛行流動**，支援 32 方位轉向與螺旋槳動態旋轉！ |
| **開場主題曲長度** | 7.12 秒 (CX16 原版取樣；正式遊玩完整播放，Demo 模式提早切斷) | Ensoniq DOC 晶片重製版 | **8.03 秒正宗 1982 街機 Gamerip 母帶**<br>(完整天然混響尾韻，PCM FIFO 耗盡自然停播) |
...
| **關卡過渡音樂** | 換關重複觸發 7.12 秒開場 PCM 音樂<br>(造成換關節奏拖沓) | 原生過關轉場音效 | **過關音樂完全解耦**：第 2 關起換關宣告改為短暫 PSG 凱旋和弦 (1.6 秒)，開場大曲僅在首局觸發 |
