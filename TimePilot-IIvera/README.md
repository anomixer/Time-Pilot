...
| **開場主題曲規格** | 7.13 秒 (CX16 原裝取樣，旋律於 7.05 秒自然淡出收尾) | Ensoniq DOC 晶片重製版 | **8.03 秒街機母帶加長版**<br>(收錄更完整之天然混響殘響尾韻，PCM FIFO 耗盡自然停播) |
...
* **VERA 16 通道立體聲 PSG 晶片合成**：雷射機砲（Down-sweep 方波）、敵彈鳴叫、空襲警報、時空躍遷升頻與凱旋和弦號角等多聲道即時並行。
* **正宗大型電玩雙軌常駐 PCM 音效**：
  * **開場主題曲 (`AUDIO_GAME_START`)**：8.03 秒正宗 1982 街機完整尾音，宣告期間戰機與雲朵全動態巡航飛行！
  * **重低音大爆炸 (`AUDIO_BIG_EXPLOSION`)**：玩家墜毀、Boss 擊破與重轟炸機爆炸時，觸發 1.37 秒正宗街機重低音 PCM，震撼力破表！
