...
1. **開機一次載入，VRAM 充當超高速板載 SSD**：
   * 開機引導階段透過 ProDOS MLI 直讀，一口氣將 **82,730 位元組（162 個磁區）的 12 首街機 PCM 取樣**（包含開場音樂、大爆炸、時空躍遷 Time Warp 穿梭音等）與 **56,640 位元組（111 個磁區）的全時代精靈圖庫**，直接寫入 VERA 擴充卡的 128 KB 獨立雙 Bank 記憶體（Bank 0 與 Bank 1）。
...
| **巨大 Boss 呈現** | 32 × 16 巨大首領機陣容<br>(Blimp/Bomber/Chinook/B-52/Mothership) | 32 × 16 巨大首領機 (65816 軟體繪製) | **正版 32 × 16 巨大首領機**，具備左右航向朝向、32px 真實碰撞盒、第五關外星母艦正宗電光青藍 (Cyan) 原色與受創洋紅警報閃爍、多重烈焰毀滅連環爆破 |
